...
public class LoansController {
    ...
    public ResponseEntity<ResponseDto> createLoan(@RequestParam String mobileNumber){
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDto(LoansConstants.STATUS_200,LoansConstants.MESSAGE_201));
    }
  ...
  //-------------------Fetch Loan Api-----------------------------
    ...
    //-------------Rest APi to get java version info using environment variable--------------
    ...
    //--------------------------rest api to get contact-info using configured properties----------------------
